      ...
      <Modal show={isOpen} onClose={closeModal} className="max-w-2xl">
        <div className="p-6 h-full ">
          {isLoading ? (
            ...
            <p className="w-full text-center font-medium text-db-pink">
              Payment Successful!
            </p>
          ) : paymentStatus === "error" ? (
            <p className="w-full text-center font-medium text-db-pink">
            ...
            <>
              <PaymentForm
                applicationId={appId}
                cardTokenizeResponseReceived={handlePaymentResponseNewCard}
              ...
              >
                ...
                <div className="pt-10 flex flex-col gap-7">
                  {cards.map((card) => {
                    return (
                      <button
                        onClick={() => handlePaymentResponseStoredCard(card.id)}
                ...
                {!showCardComponents && (
                  ...
                  >
                    ...
                    <span className="text-db-pink pl-2">card</span>
                  </button>
                )}
              ...
              <div className="flex justify-between w-full mt-10 border-b text-lg tracking-wider ">
                <p className=" font-light tracking-widest">Subtotal </p>
